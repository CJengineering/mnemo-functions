...
const testPrompts = [
  {
    name: "Event Creation",
    type: "event",
    prompt: "Create a Climate Innovation Summit happening on September 15, 2025 in Dubai. It should be a featured event focusing on sustainable technology breakthroughs. The event will run for 2 days with presentations from leading researchers.",
    context: "This is a high-profile event for the Community Jameel initiative"
  },
  {
    name: "Blog Post Creation", 
    type: "post",
    prompt: "Write a blog post about artificial intelligence in healthcare, focusing on recent breakthroughs in medical diagnosis. It should be published on August 1, 2025 and featured on the homepage.",
    context: "Target audience: healthcare professionals and researchers"
  },
  {
    name: "News Article",
    type: "news", 
    prompt: "Create a news article about a breakthrough in solar panel efficiency achieved by MIT researchers. The research was published today and shows 40% improvement in energy conversion.",
    context: "Breaking news item for immediate publication"
  },
  {
    name: "Programme Description",
    type: "programme",
    prompt: "Create a programme description for the 'Urban Innovation Lab' - a new initiative focused on smart city technologies, established in 2025, headquartered in Abu Dhabi.",
...
async function runIntegrationTests() {
  ...
  console.log("⚠️  Note: These tests require a valid OpenAI API key in your .env file");
  ...
  const completePrompts = testPrompts.filter(p => p.name !== "Incomplete Event (Missing Fields)");
  ...
  if (totalFailed === 0) {
    ...
    console.log("🤖 The prompt-to-collection-item system is working correctly!");
  } else {

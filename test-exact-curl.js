...
function testExactCurlData() {
  ...
  const curlData = {
    ...
    data: {
      ...
      seoMeta:
        "Exploring the latest trends and breakthroughs in artificial intelligence technology for 2025",
      bodyEnglish:
        "This is a comprehensive blog post about the exciting developments in AI technology...",
      location: "Dubai, UAE",
      thumbnail: {
